    ...
    try:
        with open(filename, "r", encoding="utf-8") as file:
            ...
            marginal_probabilities = {
                char: freq / total_chars for char, freq in char_frequency.items()
            }
            ...
            for char, following_chars in pair_frequency.items():
                ...
                for following_char, count in following_chars.items():
                    conditional_probabilities[char][following_char] = (
            ...
            if is_memoryless:
                ...
                if n is not None:
                    ...
                    entropy_src = calculate_entropy(marginal_probabilities.values())
                ...
                for i, char in enumerate(chars):
                    for j, following_char in enumerate(chars):
                        transition_matrix[i, j] = conditional_probabilities[char].get(
                            following_char, 0
                        )
                ...
                log_values[non_zero_mask] = transition_matrix[non_zero_mask] * np.log2(
                    1 / transition_matrix[non_zero_mask]
                )
